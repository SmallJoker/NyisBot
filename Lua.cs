...
namespace MAIN
{
	...
	{
		private const string DLLFILE = "luajit";
		private const CallingConvention CALL = CallingConvention.Cdecl;
		private const CharSet CHAR = CharSet.Auto;
		...
		*/
		...
		[DllImport(DLLFILE, CallingConvention = CALL)]
		...
		*/
		...
		[DllImport(DLLFILE, CallingConvention = CALL)]
		public static extern IntPtr lua_typename(IntPtr lua_State, int tp);
		...
		[DllImport(DLLFILE, CallingConvention = CALL)]
		public static extern IntPtr lua_tolstring(IntPtr lua_State, int idx, UIntPtr len);
		...
		*/
		...
		[DllImport(DLLFILE, CallingConvention = CALL, CharSet = CHAR)]
		public static extern void lua_pushstring(IntPtr lua_State, string s);
		//LUA_API const char *(lua_pushvfstring) (lua_State *L, const char *fmt,
		//                                                      va_list argp);
		//LUA_API const char *(lua_pushfstring) (lua_State *L, const char *fmt, ...);
		//LUA_API void  (lua_pushcclosure) (lua_State *L, lua_CFunction fn, int n);
		//[DllImport(DLLFILE, CallingConvention=CALL, CharSet=CharSet.Ansi)]
		[DllImport(DLLFILE, CallingConvention = CALL)]
		...
		*/
		...
		public static int lua_strlen(IntPtr lua_State, int i)
		{
		...
		{
			return Marshal.PtrToStringAnsi(lua_tolstring(lua_State, i, UIntPtr.Zero));
		}
		...
		*/
		...
		//[DllImport(DLLFILE, CallingConvention = CALL, CharSet = CHAR)]
		//public static extern void luaL_error(IntPtr lua_State, string s);
		public static void luaL_error(IntPtr L, string s) {}
	}
}
